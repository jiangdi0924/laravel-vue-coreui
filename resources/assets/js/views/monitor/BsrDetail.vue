        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-2">
                <div class="card card-accent-success">
                    ...
                    <div class="card-block">
                        <b>平均评论数：</b>
                        <p>{{listInfo.avg_listing_review_count}}</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-2">
...
import BsrDetailOption from './BsrDetailOption'

Vue.use(VueEvents)
Vue.component('bsr-actions', BsrAction)
Vue.component('my-detail-row', DetailRow)
Vue.component('filter-bar', FilterBar)
Vue.component('bsr-detail-option', BsrDetailOption)
...
export default {
    ...
    data() {
        return {
            listInfo: '',
            loading: true,
            url: '/bsr/bsrdetail?bsr_id=' + this.$route.params.bsrId,
            largeModal: false,
            options: {
                filterByColumn: true,
                listColumns: {
            ...
            fields: [
                ...
                {
                    name: '__component:bsr-detail-option',
                    title: '操作',
                    titleClass: 'text-center',
                    dataClass: 'text-center'
                }
    ...
    methods: {
        ...
        getBsrListInfo() {
            axios.post('/bsr/bsrlist', { bsr_id: this.$route.params.bsrId })
                .then(response => {
